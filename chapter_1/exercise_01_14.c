...
void countwordlenght(int letters[], char text[], int limit);
void countsymbols(int letters[], char text[], int limit);
...
int main()
{
	...
	countsymbols(letters, text, MAX_LENGTH);
	printresult(letters, 500);
	printsymbols('-', 35);
	printf("\n");
	printhistogram(letters, 35, 500);
